...
project = 'TSMD'
copyright = '2025, Valerio Guerrini, Thibaut Germain, Charles Truong, Laurent Oudre, Paul Boniol'
author = 'Valerio Guerrini, Thibaut Germain, Charles Truong, Laurent Oudre, Paul Boniol'
release = '0.0.1'
